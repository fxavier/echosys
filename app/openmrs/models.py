...
class Inscricao(models.Model):
    ...
    data_teste_hiv_pos = models.DateTimeField(
        blank=True, null=True)
    teste_hiv_pos = models.ForeignKey(
        TesteHivPos, on_delete=models.CASCADE, blank=True, null=True)
    ...
    transferido_em = models.CharField(max_length=100, null=True, blank=True)
...
class ConsultaClinica(models.Model):
    ...
    diagnostico_its = models.ForeignKey(
        DiagnosticoITS, on_delete=models.SET_NULL, null=True)
